...
export const CreatorSpacePage: React.FC<CreatorSpacePageProps> = ({ slug, onCreateAsset, onEditAsset, onOpenAuth, onOpenFolderManager, onOpenSettingsModal, allKnownAssets = [], knownFolders = [], isLoadingAssets = false, isLoadingFolders = false, bookmarkedAssetIds = [], recentlyViewedIds = [], onDeleteAsset, onRestoreAsset }) => {
